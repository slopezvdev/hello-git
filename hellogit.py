...
git branch login crea una rama diferente a main, llamada login, en el mismo summin en el que estamos, teniendo el head en el main y aparte tenemos el login
